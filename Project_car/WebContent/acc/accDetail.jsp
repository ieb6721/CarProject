					...
					<div class="product__wrap clearfix">
							...
							<div class="category">
								<div class="ht__cat__thumb">
									<a href="product-details.html"> <img
										src="../images/accessory_img/product/1.jpg"
										alt="product images">
									</a>
								</div>
						...
						<div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
							<div class="category">
								<div class="ht__cat__thumb">
									<a href="product-details.html"> <img
										src="../images/accessory_img/product/2.jpg"
										alt="product images">
									</a>
								</div>
								<div class="fr__hover__info">
						...
						<div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
							<div class="category">
								<div class="ht__cat__thumb">
									<a href="product-details.html"> <img
										src="../images/accessory_img/product/3.jpg"
										alt="product images">
									</a>
								</div>
								<div class="fr__hover__info">
						...
						<div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
							<div class="category">
								<div class="ht__cat__thumb">
									<a href="product-details.html"> <img
										src="../images/accessory_img/product/4.jpg"
										alt="product images">
									</a>
								</div>
								<div class="fr__hover__info">
