...
<div class="col-md-9 col-sm-12">
	<div class="blog-content-area">
		...
		<div class="post-content">
			...
			<br>
			<p>그 이유는 ‘퓨얼 컷 (fuel-cut)’이라는 기능 때문인데요. 퓨얼 컷은 관성주행을 통해 연료 소모를 줄이는
			...
			<p>일반적으로 가솔린 1,500rpm, 디젤 1,300rpm 이상에서 작동되며 차종 또는 제조사마다 조건이 다르니
				내 차는 어떤지 미리 알아둘 필요가 있습니다.만약 내리막길에서 기어를 중립에 두면 rpm이 떨어져 퓨얼 컷 작동을 방해해
				연료절감 효과를 볼 수 없게 되겠죠? 연비를 위해서라도 내리막길에서는 D단으로 주행해야 합니다.</P>
			<br>
			...
			<br>
			<p>긴 내리막길에서 오랜 시간 브레이크를 밟으면 마찰열로 인해 휠 실린더나 브레이크 파이프 속의 브레이크액이 기화될
			...
			<p>이를 '베이퍼 록(vapor lock)' 현상이라고 부르는데요. 브레이크가 정상적으로 작동하지 않기 때문에 큰
				사고로도 이어질 수 있습니다. 내 차량의 상태와 안전을 위해서라도 내리막길에서는 꼭 D단을 유지해야겠죠?</P>
			<br>
			...
			<br>
			<p>내리막길에서 갑자기 멈춰 선 앞 차를 보고 브레이크를 급하게 밟는다 해도, 관성이 붙은 차를 순수 브레이크만으로
				멈춰야 하기 때문에 제동력이 떨어져 앞 차와 부딪힐 확률이 커집니다.</P>
			<br>
			...
			<P>반면 D단일 경우 엔진브레이크가 걸린 상태로 주행을 하고 있었기 때문에 풋 브레이크와 함께 차량을 안정적이고,
				...
				내려오시는 것을 권장 드립니다.</p>
			<br>
			<p>이렇듯 주행 중에는 언제 어떤 상황이 벌어질지 모르기 때문에, 내리막이든 평지이든 주행 중에는 기어를 D단으로
				놓는 것이 안전합니다!</P>
