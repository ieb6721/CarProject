  ...
  function sendIt() {
    ...
    <body>
        ...
        <div class="waraper">
            ...
            <!-- register-area start -->
            <form method="post" action="../register/register_ok.do" name="registerFrm" onsubmit="return sendIt();">
                            ...
                            <div class="login">
                                <div class="login-form-container">
                                    ...
                                    <div class="login-form">
                                            ...
                                            <input type=text name=addr id=addr1 size=45 readonly required="required">
