...
$(function(){
	...
	var addr_search = $('#addr_search').val();
					...
					<div class="col-lg-8">
								...
								<div class="blog-post-body">			
									<div class="blog-post-image text-left">
										...
										<map name="map01">
											...
											href="#" onmouseover="링크경로명" id="강원도" onclick="javascript:alert('강원도')">
											<area shape="poly" alt="" title="" coords="150,37,115,52,115,60,96,74,106,85,90,96,85,104,92,118,114,112,113,123,130,104,156,120,154,130,127,139,114,132,102,140,90,161,102,171,103,187,117,196,166,193,210,166,201,160,212,121,187,114,186,81,152,52,154,49"
											 ...
											 href="#" onmouseover="링크경로명" id="서울특별시" onclick="javascript:alert('서울특별시')" />
											 <area shape="poly" alt="" title="" coords="72,83,54,102,78,136,100,140,103,138,113,133,109,114,90,120,82,101,89,92,89,92"
											 href="#" onmouseover="링크경로명" id="인천광역시" onclick="javascript:alert('인천광역시')" />
											 ...
											 href="#" onmouseover="링크경로명" id="경북" onclick="javascript:alert('경북')" />
											 <area shape="poly" alt="" title="" coords="292,305,266,323,276,336,269,347,284,348,306,320,297,304"
											 href="#" onmouseover="링크경로명" id="대구" onclick="javascript:alert('대구')" />
											 ...
											 href="#" onmouseover="링크경로명" id="전남" onclick="javascript:alert('전남')" />
											 <area shape="poly" alt="" title="" coords="95,389,87,401,103,420,121,416,138,409,138,400,129,388"
											 href="#" onmouseover="링크경로명" id="광주" onclick="javascript:alert('광주')" />
											 ...
											 href="#" onmouseover="링크경로명" id="전북" onclick="javascript:alert('전북')" />
											 ...
											 href="#" onmouseover="링크경로명" id="충남" onclick="javascript:alert('충남')" />
											 <area shape="poly" alt="" title="" coords="167,242,145,263,161,275,183,277,193,273,193,255,177,247"
											 href="#" onmouseover="링크경로명" id="대전" onclick="javascript:alert('대전')" />
											 ...
											 href="#" onmouseover="링크경로명" id="충북" onclick="javascript:alert('충북')" />
						...
						<div class="col-lg-7 addr_search">
							<ul>
								<li><h4>지역 검색</h4></li>
								<li>
									<input type="text" id=local_search>
								...
								<li><h4>주소 검색</h4></li>
								<li>
									<input type="text" id=addr_search>
